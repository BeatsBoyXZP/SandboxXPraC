package ru.ssau.tk.BeatsBoyXZP.SandboxXPaC.TheGame;
...
class TheGame extends JFrame {

    final String TITLE_OF_PROGRAM = "TheGameFrom";
    ...
    class Xonix {
        ...
        void paint(Graphics g) {
            g.setColor((field.getColor(x, y) == COLOR_LAND) ? new Color(0x954A95) : Color.white);
            g.fillRect(x*POINT_SIZE, y*POINT_SIZE, POINT_SIZE, POINT_SIZE);
